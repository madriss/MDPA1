...
public class Aii extends Configured implements Tool {
	...
	public int run(String[] args) throws Exception {
		System.out.println(Arrays.toString(args));
		Job job = new Job(getConf(), "Using 10 reducers and a combiner");
		job.setJarByClass(Aii.class);
		...
		job.setCombinerClass(Reduce.class); // we set the combiner
		FileOutputFormat.setCompressOutput(job, true);
		FileOutputFormat.setOutputCompressorClass(job, org.apache.hadoop.io.compress.LZ4Codec.class);
